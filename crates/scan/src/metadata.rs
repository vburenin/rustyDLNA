...
pub struct MediaItem {
    ...
    /// Spoiler-safe description. Video values come from NFO `<outline>`;
    /// other media use their embedded descriptive comment.
    pub about: Option<String>,
    /// Full video plot from NFO `<plot>`. This can contain spoilers.
