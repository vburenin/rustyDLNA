...
const dom = {
  ...
  streamInfoDownload: required("stream-info-download"),
  streamDiagnostics: required("stream-diagnostics"),
  streamDiagnosticFacts: required("stream-diagnostic-facts"),
  ...
  captionError: required("caption-error"),
  captionErrorMessage: required("caption-error-message"),
  captionRetry: required("caption-retry"),
  captionOff: required("caption-off"),
