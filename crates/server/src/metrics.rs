...
impl RuntimeMetrics {
    ...
    pub(crate) fn record_request(
        ...
        self.routes[route_index(route)].record(status, elapsed);
    ...
    pub(crate) fn json(&self) -> Value {
        ...
        for route in all_routes() {
            routes.insert(
                ...
                self.routes[route_index(route)].json(),
            );
        }
...
fn all_routes() -> [HttpRoute; ROUTE_COUNT] {
    [
        HttpRoute::RootDesc,
...
fn route_index(route: HttpRoute) -> usize {
    match route {
        HttpRoute::RootDesc => 0,
        HttpRoute::ScpdContentDir => 1,
        HttpRoute::ScpdConnectionMgr => 2,
        HttpRoute::ScpdRegistrar => 3,
        HttpRoute::Soap => 4,
        HttpRoute::EventContentDir => 5,
        HttpRoute::EventConnectionMgr => 6,
        HttpRoute::EventRegistrar => 7,
        HttpRoute::MediaItem => 8,
        HttpRoute::Transcode => 9,
        HttpRoute::Thumbnail => 10,
        HttpRoute::AlbumArt => 11,
        HttpRoute::Resized => 12,
        HttpRoute::Icon => 13,
        HttpRoute::Caption => 14,
        HttpRoute::Status => 15,
        HttpRoute::Health => 16,
        HttpRoute::ApiStatus => 17,
        HttpRoute::Presentation => 18,
        HttpRoute::NotFound => 19,
    }
}
