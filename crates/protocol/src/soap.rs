...
/// Advance the UPnP `ui4` SystemUpdateID, wrapping at the wire boundary.
pub const fn next_system_update_id(current: u32) -> u32 {
...
mod tests {
    ...
    #[test]
    fn system_update_id_wraps_at_ui4_boundary() {
        assert_eq!(next_system_update_id(u32::MAX), 0);
    }
